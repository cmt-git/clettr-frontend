    ...
    >
      ...
      >
        <svg
          ...
          width="16.971"
          height="26.416"
          viewBox="0 0 16.971 26.416"
          className={style.close_button}
          style={{ width: "10px" }}
        >
          <g transform="translate(0 26.416)">
            <path
              d="M13.237-26.416,0-13.179,3.734-9.445,16.971-22.682Z"
              fill="#d08080"
              fill-rule="evenodd"
            />
            <path
              d="M13.237,0,0-13.237l3.734-3.734L16.971-3.734Z"
              fill="#d08080"
              fill-rule="evenodd"
            />
          </g>
      ...
      <InventoryBlockComponent
        ...
        not_user={props.not_user}
        nft_type={"Search All No Market"}
