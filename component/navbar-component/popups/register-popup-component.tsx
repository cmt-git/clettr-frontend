...
const RegisterPopupComponent = (address: string) => {
  ...
  const validateInput = () => {
    ...
    if (
      ...
      if (username === "") {
        ...
        link_messageBoxShow(
          "Password requires max character of 100, minimum of 8.",
          false
        );
      } else if (confirm_password.length > 100 || confirm_password.length < 8) {
        link_messageBoxShow(
          "Confirm Password requires max character of 100, minimum of 8.",
          false
        );
  ...
  return (
    ...
    >
      ...
      <p style={{ width: "100%", textAlign: "center" }}>Register</p>
