    ...
    <div className={style.energy_dashboard_popup_root}>
      <div className={style.energy_dashboard_main}>
        ...
        <p className={style.transparent_text}>
          Energy resets at 12:00 PM GMT+8 everyday. Energy limit can be
          increased based on how many{" "}
          <span
            className={style.link_hover}
        ...
        <div className={style.energy_limit_container}>
          <div className={style.energy_limit_info_container}>
            <div className={style.left_container}>
              ...
              <p style={{ marginRight: "10px" }}>3 Max</p>
            </div>
            <p className={style.right_container}>Below 20 Active NFTs</p>
          </div>
          <div className={style.energy_limit_info_container}>
            <div className={style.left_container}>
              <svg
              ...
              <p style={{ marginRight: "10px" }}>5 Max</p>
            </div>
            <p className={style.right_container}>Above 20 Active NFTs</p>
          </div>
          <div className={style.energy_limit_info_container}>
            <div className={style.left_container}>
              <svg
              ...
              <p style={{ marginRight: "10px" }}>8 Max</p>
            </div>
            <p className={style.right_container}>Above 40 Active NFTs</p>
          </div>
          <div className={style.energy_limit_info_container}>
            <div className={style.left_container}>
              <svg
              ...
              <p style={{ marginRight: "10px" }}>12 Max</p>
            </div>
            <p className={style.right_container}>Above 65 Active NFTs</p>
          </div>
          <div
            className={style.energy_limit_info_container}
          ...
          >
            <div className={style.left_container}>
              ...
              <p style={{ marginRight: "10px" }}>15 Max</p>
            </div>
            <p className={style.right_container}>Above 80 Active NFTs</p>
          </div>
        </div>
      </div>
    </div>
