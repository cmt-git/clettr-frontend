...
const LeaderboardPopupComponent = () => {
            ...
            <div className={style.profile_block}>
                <div className={style.grey_info_block}>
                    <p style={{color:'rgba(255, 255, 255, 0.5)'}}>
                        <span className={style.yellow_text}>#1</span> Player <span>test-</span>
                    </p>
                    <p style={{color:'rgba(255, 255, 255, 0.5)'}}>
    ...
    return( 
        <div className={style.popup_content_root} style={{maxWidth:"750px", width:"100vw"}}>
            ...
            <div style={{display:"flex", flexDirection: _width > 650 ? "row" : "column", justifyContent:"space-between", alignItems:"center", marginBottom:"15px"}}>
                ...
                <p style={{color:"rgba(255, 255, 255, 0.5)", textAlign:"center" }}>
                    <span style={{color:"white"}}>1,234,454</span> Players
                </p>
            </div>
            <div className={style.line}></div>
            <div
                style={{display:"flex", justifyContent:"center", alignItems:"center", gap:"15px", marginBottom:"15px"}} 
            >
