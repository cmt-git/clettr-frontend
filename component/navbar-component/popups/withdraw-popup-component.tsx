  ...
  return (
    ...
    >
      ...
      >
        ...
        worth of Ettr. If you proceed on withdrawing, you will not be able to
        withdraw again in the next 30 days.
      </p>
      <p>Wallet Address</p>
      <div
      ...
      <p style={{ marginTop: "15px" }}>Blockchain</p>
      <div
        className={style.black_info_block}
        style={{ marginTop: "5px", display: "flex", alignItems: "center" }}
      >
        ...
        <input
          ...
          onInput={(e: React.ChangeEvent<HTMLInputElement>) => {
            ...
            if (Number(_value) >= queryState.user_info.unclaimed_ettr) {
              e.target.value = decimalFormatter(
                queryState.user_info.unclaimed_ettr
              );
      ...
      <div
        ...
        onClick={() => {
          ...
          if (
            Number(queryState.user_info.unclaimed_ettr) >= filtered_iv &&
            filtered_iv >= 10
          ) {
