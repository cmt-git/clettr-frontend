      ...
      <div style={{ maxWidth: "80px" }}>
        ...
        <p>
          {_props?.data?.transaction_type == "play"
            ? "Play"
            : _props?.data?.transaction_type == "mint_passive"
            ? "Mint (Passive)"
            : _props?.data?.transaction_type == "mint_active"
            ? "Mint (Active)"
            : _props?.data?.transaction_type == "market_buy"
            ? "Market Buy"
            : _props?.data?.transaction_type == "market_sell"
            ? "Market Sell"
            : _props?.data?.transaction_type == "market_buy_passive"
            ? "Market Buy (Passive)"
            : _props?.data?.transaction_type == "market_buy_active"
            ? "Market Buy (Active)"
            : _props?.data?.transaction_type == "market_sell_passive"
            ? "Market Sell (Passive)"
            : _props?.data?.transaction_type == "market_sell_active"
            ? "Market Sell (Active)"
            : _props?.data?.transaction_type == "forge"
            ? "Forge"
            : _props?.data?.transaction_type == "forge_active"
            ? "Forge (Active)"
            : _props?.data?.transaction_type == "forge_passive"
            ? "Forge (Passive)"
