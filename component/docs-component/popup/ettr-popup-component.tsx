    ...
    <div className={style.docs_popup_component_root}>
      ...
      >
        <img
          ...
          style={{ width: "50px" }}
        />
        <p style={{ marginLeft: "10px", fontSize: "25px" }}>Ettr</p>
      </div>
      ...
      >
        Ettr is the token used by Clettr. It is minted by rewards after
        gameplay. Its price, like any other cryptocurrency revolves around its
        demand. Its supply and demand is heavily affected by the{" "}
        <span>Random Hash System</span> and by Clettr's forging system and
        marketplace. Ettr is exclusively used on Clettr.
      </p>
    </div>
  );
};
