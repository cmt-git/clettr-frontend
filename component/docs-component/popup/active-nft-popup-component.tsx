  ...
  return (
    <div className={style.docs_popup_component_root}>
      ...
      <p
        ...
        style={{ lineHeight: "25px", marginTop: "20px" }}
      >
        Active NFTs are one of the two NFT categories in Clettr along with{" "}
        <a href="">Passive NFTs</a>. Active NFTs are also called Letters, and is
        the most unstable in terms of prices among the two as the price of
        Passive NFTs is constant. From its name, Active NFTs can only be used
        actively to be able to earn unlike its counter part which can earn
        passively, Active NFTs can only not be shared. The value of a Active NFT
        can also go up depending on the demand for its hash or traits, and can
      ...
      >
        Active NFTs has multiple traits compared to Passive NFTs these are
        patterns, colors, letters, and stars. These traits would need to match
        the requirement of a node for it to be able to be partnered with it.
        Active NFTs can also be forged for requirements or for more rewards, as
        the more stars an Active NFT has it add a little bit more rewards per
        round.
      </p>
      <div
        style={{
      ...
      >
        Unlike Passive NFTs, Active NFTs only have 2 hashes so it would need 5
        more partners called a Set and this would be able to for a hash of 10
        characters allowing players to play the game.
      </p>
