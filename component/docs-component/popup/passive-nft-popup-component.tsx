  ...
  return (
    <div className={style.docs_popup_component_root}>
      ...
      >
        ...
        rewards. The value of a Passive NFT can also go up depending on the
        demand for its hash, and can resold in the marketplace.
      </p>
      <p
        className={style.transparent_text}
        style={{
      ...
      >
        Passive NFTs also have requirements, which simply means for it be
        partnered with Active NFTs it must meet its requirement. For example if
        a Passive NFT has a requirement of 3 Stars, and Striped only Active NFTs
        with the same traits can be partnered with it. Passive NFTs can also be
        forged, and the more stars a Passive NFT has, the more rewards it will
        be able to give per round.
      </p>
      <div
        style={{
          display: "flex",
      ...
      >
        Passive NFTs also have its own traits, like colors. This colors can be
        used to predict the starting letter of the words that are going to need
        to be cracked during gameplay. However it can only predict 4 Letters as
        the other Letter is Randomed.
      </p>
      <div
        style={{
          display: "flex",
      ...
      >
        <div
          ...
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <p className={style.transparent_text}>Pink</p>
          <p style={{ display: "flex", alignItems: "center" }}>A B C D</p>
        </div>
        <div
          className={style.grey_info_block}
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <p className={style.transparent_text}>Purple</p>
          <p>D E F G</p>
        </div>
        <div
          className={style.grey_info_block}
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <p className={style.transparent_text}>Blue</p>
          <p>G H I J</p>
        </div>
        <div
          className={style.grey_info_block}
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <p className={style.transparent_text}>Teal</p>
          <p>J K L M</p>
        </div>
        <div
          className={style.grey_info_block}
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <p className={style.transparent_text}>Lime</p>
          <p>M N O P</p>
        </div>
      </div>
      <div
      ...
      >
        <div
          ...
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <p className={style.transparent_text}>Green</p>
          <p style={{ display: "flex", alignItems: "center" }}>P Q R S</p>
        </div>
        <div
          className={style.grey_info_block}
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <p className={style.transparent_text}>Yellow</p>
          <p>S T U V</p>
        </div>
        <div
          className={style.grey_info_block}
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <p className={style.transparent_text}>Orange</p>
          <p>V W X Y</p>
        </div>
        <div
          className={style.grey_info_block}
          style={{ display: "flex", justifyContent: "space-between" }}
        >
          <p className={style.transparent_text}>Red</p>
          <p>Y Z A B</p>
        </div>
      </div>
    </div>
