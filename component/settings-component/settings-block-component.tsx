        ...
        <div className={style.settings_block_component_root}>
            <div>
                <div className={style.settings_block_navbar}>
                    ...
                    <div className={settingsPopupIndex == 1 ? style.settings_dashboard_selected : style.settings_dashboard_button}
                    ...
                    <div className={settingsPopupIndex == 2 ? style.settings_dashboard_selected : style.settings_dashboard_button}
                    ...
                    <div className={settingsPopupIndex == 3 ? style.settings_dashboard_selected : style.settings_dashboard_button}
                    ...
                    <div className={settingsPopupIndex == 5 ? style.settings_dashboard_selected : style.settings_dashboard_button}
                    ...
                    <div className={settingsPopupIndex == 6 ? style.settings_dashboard_selected : style.settings_dashboard_button}
