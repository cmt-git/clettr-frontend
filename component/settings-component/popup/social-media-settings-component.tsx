    ...
    <div className={style.settings_popup_root}>
      ...
      <div className={style.input_container}>
        <div className={style.input_info}>
          <p className={style.transparent_text}>Discord</p>
          <p>@hehe #4333</p>
        </div>
      ...
      <div className={style.input_container} style={{ marginTop: "15px" }}>
        <div className={style.input_info}>
          <p className={style.transparent_text}>Facebook</p>
          <p>@test-facebook</p>
        </div>
        <div className={style.input_box}>
          <img
      ...
      <div className={style.input_container} style={{ marginTop: "15px" }}>
        <div className={style.input_info}>
          <p className={style.transparent_text}>Instagram</p>
          <p>@test-instagram</p>
        </div>
        <div className={style.input_box}>
          <img
      ...
      <div className={style.input_container} style={{ marginTop: "15px" }}>
        <div className={style.input_info}>
          <p className={style.transparent_text}>Tiktok</p>
          <p>@test-tiktok</p>
        </div>
        <div className={style.input_box}>
          <img
      ...
      <div className={style.input_container} style={{ marginTop: "15px" }}>
        <div className={style.input_info}>
          <p className={style.transparent_text}>Twitter</p>
          <p>@test-twitter</p>
        </div>
        <div className={style.input_box}>
          <img
      ...
      <div className={style.input_container} style={{ marginTop: "15px" }}>
        <div className={style.input_info}>
          <p className={style.transparent_text}>Youtube</p>
          <p>@test-youtube</p>
        </div>
        <div className={style.input_box}>
          <img
