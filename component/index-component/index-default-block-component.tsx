...
const IndexDefaultBlockComponent = () => {
  ...
  return (
    <div className={style.index_default_block_component_root}>
      ...
      <div className={style.earn_container}>
        ...
        <div className={style.info_block_container}>
          <div className={style.grey_info_block}>
            <p className={style.transparent_text}>Players</p>
            <p>
              {queryState != null
          ...
          <div className={style.grey_info_block}>
            <p className={style.transparent_text}>NFT Circulation</p>
            <p>
              {queryState != null
        ...
        <div className={style.info_block_container}>
          <div className={style.grey_info_block}>
            <p className={style.transparent_text}>Ettr Minted</p>
            <p>
              {queryState != null
        ...
        <div
          ...
          style={{ padding: "15px", fontSize: "16px", marginBottom: "50px" }}
      ...
      <div
        className={style.bottom_block_container}
