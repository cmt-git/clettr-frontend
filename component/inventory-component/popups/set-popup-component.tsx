...
import { calculateActiveBoost, getComparedHash } from '../../../scripts/misc/compareHash';
...
const SetPopupComponent = () => {
    ...
    useEffect(() => {
        if (addItemIndexState == null || store.getState().addItemTypeState.value != "set_popup"){
            let init_arr: any = []
            ...
            store.dispatch({type: 'edit/addItemTypeReducer/SET', value: "set_popup"});
        }
                                ...
                                <span>
                                    {
                                        addItemIndexState != null && addItemIndexState[i] != null ?
                                            <ItemBlockComponent no_borders={true} inventory_popup={true} data={addItemIndexState[i]} add_index={i}/>
                                        :
